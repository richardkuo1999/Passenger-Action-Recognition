...
class DarknetRes(nn.Module):
    ...
    def forward(self, img, targets=None, conf_thres1=0.5, nms_thres1=0.5):
        ...
        # for inferencing
            ...
            #print('oh')
            det1, cla_res = self.forward_inference(img, conf_thres1, nms_thres1)
            return det1, cla_res
        else:
    ...
    def forward_train(self, img, targets=None):
        ...
        self.img_size2 = self.nG
        
        # generate crop_xyxy
        crop_xyxy = targets.clone()
        #print('\ncrop_xyxy: ',type(crop_xyxy))
...
def load_darknet_weights(self, weights, cutoff=-1):
    ...
    ptr = 0
    print(enumerate(zip(self.module_defs[:cutoff], self.module_list[:cutoff])))
