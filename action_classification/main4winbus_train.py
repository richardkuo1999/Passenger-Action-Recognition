...
parser.add_argument( '--annotation_path',default='data/winbusTrain-06/winbus_06-2-3-4_test2times.json',
...
parser.add_argument( '--use_mix', default=True, action='store_true',
