...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer4 = self._make_layer(
            blockx, 512, layers[3], shortcut_type, stride=2)
...
def resnet18(**kwargs):
    """Constructs a ResNet-18 model.
    """
    model = ResNet(BasicBlockX, BasicBlockX, [2, 2, 2, 2], **kwargs)
    return model
...
def resnet34(**kwargs):
    ...
    """
    model = ResNet(BasicBlock, BasicBlockX, [3, 4, 6, 3], **kwargs)
    return model
...
def resnet50(**kwargs):
    ...
    """
    model = ResNet(BottleneckX, BottleneckX, [3, 4, 6, 3], **kwargs)
    return model
