...
#     parser.add_argument( '--video_path',default='traindata/winbus-06-2RoHf',
#                         type=str, help='Directory path of Videos')
#     parser.add_argument( '--annotation_path',default='data/winbusTrainTest-06/winbus_06-2-3-4_test2times.json',
#                         type=str, help='Annotation file path')
#     parser.add_argument( '--result_path',default='trainresults/results_06',
...
#     parser.add_argument( '--n_classes',default=1039,
#                         type=int, help='Number of classes (activitynet: 200, kinetics: 400, ucf101: 101, hmdb51: 51)')
#     parser.add_argument( '--n_finetune_classes', default=4,
...
#     parser.add_argument( '--sample_duration',default=15,
...
#     parser.add_argument( '--pretrain_path', default='r2p1d50_KM_200ep.pth', 
...
#     parser.add_argument( '--test_weight', action='store_true',
